"""Control Flow Flattening Pass — port of Pluto Flattening.cpp.

Flattens function control flow into a switch-based dispatcher,
making static analysis significantly harder.
"""
...
from shifting_codes.utils.ir_helpers import demote_phi_to_stack
...
class FlatteningPass(FunctionPass):
    ...
    def run_on_function(self, func: llvm.Function, ctx: llvm.Context) -> bool:
        ...
        for bb in original_blocks:
            ...
            block_state_map[id(bb)] = (bb, state)
        ...
        for bb in all_blocks_to_modify:
            ...
            if len(succs) == 1:
                target = succs[0]
                target_entry = block_state_map.get(id(target))
                ...
                true_bb = succs[0]
                false_bb = succs[1]
                true_entry = block_state_map.get(id(true_bb))
                false_entry = block_state_map.get(id(false_bb))
